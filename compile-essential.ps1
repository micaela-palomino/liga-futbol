# Script para compilar solo las clases esenciales sin algoritmos
Write-Host "Compilando solo las clases esenciales..." -ForegroundColor Green
Write-Host ""
...
Write-Host "Compilando clases modelo..." -ForegroundColor Yellow

# Compilar solo las clases modelo y DataLoader
$sourceFiles = @(
    ...
    "src\main\java\com\uade\ligafutbol\controller\*.java",
    "src\main\java\com\uade\ligafutbol\service\LigaService.java",
